...
contract FuzzTest is Test {
    ...
    function setUp() public {
        ...
        vault = new YieldVault(address(wrbtc), a, COOLDOWN, THRESHOLD, REWARD_BPS, MAX_RATE, CAP_BPS, TVL_CAP);
        ...
        evault = new ERC20YieldVault(
            address(doc), ea, COOLDOWN, THRESHOLD, REWARD_BPS, MAX_RATE, CAP_BPS, TVL_CAP, "DOC Vault", "yvDOC", address(this)
        );
